...
class Savingsaccounts__DetailsRecyclerViewAdapter(private val recyclerViewData: List<Database__Transaction>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is ViewHolder) {
            ...
            holder.priceTextView.text = "€" + Math.round(transaction.amount).toString()
