...
class Savingsaccounts__DetailsRecyclerViewAdapter(private val recyclerViewData: List<Database__Transaction>) : RecyclerView.Adapter<Savingsaccounts__DetailsRecyclerViewAdapter.ViewHolder>() {
